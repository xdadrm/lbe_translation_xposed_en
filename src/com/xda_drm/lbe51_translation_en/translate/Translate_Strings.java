...
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Audio_Controll","The control handset volume"); } catch(RuntimeException e) { };
...
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Get_Wifi_Info","Gets information phone WIFI"); } catch(RuntimeException e) { };
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Change_Wifi_Status","Changing the status WIFI"); } catch(RuntimeException e) { };
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Read_SMS",". Read the text message"); } catch(RuntimeException e) { };
...
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Make_Call","Calls to phone"); } catch(RuntimeException e) { };
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Open_Camera","Open the cell phone camera"); } catch(RuntimeException e) { };
...
try { resparam.res.setReplacement("com.lbe.security", "string", "AD_Behavior_Send_SMS","Send a short message"); } catch(RuntimeException e) { };
...
try { resparam.res.setReplacement("com.lbe.security", "string", "Nft_Mgr_Reject","Refuse"); } catch(RuntimeException e) { };
try { resparam.res.setReplacement("com.lbe.security", "string", "Nft_Mgr_Accept","Allow"); } catch(RuntimeException e) { };
try { resparam.res.setReplacement("com.lbe.security", "string", "Nft_Mgr_Reject_Title","Rejected (%1$d)"); } catch(RuntimeException e) { };
